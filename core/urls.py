...
from video_app.views import VideoConversionProgressView, VideoUploadView, VideoListView, VideoDetailView, VideoClearCache
from accounts_app.views import RegisterUserView, LoginUserView, ActivateAccountView, RequestNewActivationLinkView, PasswordResetRequestView, PasswordResetConfirmView, DeleteAccountView, UserProfileView,  RegisterUserEmailView, VerifyResetCodeView
